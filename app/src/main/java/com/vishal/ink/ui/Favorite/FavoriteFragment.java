package com.vishal.ink.ui.Favorite;
...
import com.vishal.ink.databinding.FragmentFavoriteBinding;
import com.vishal.ink.ui.Favorite.RecyclerViewFavorite.RecyclerViewFavoriteAdapter;

import java.util.concurrent.Executors;

public class FavoriteFragment extends Fragment implements RecyclerViewFavoriteAdapter.Listener {
    ...
    private FragmentFavoriteBinding getBinding() {
        return _binding;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        favoriteRecyclerView = getBinding().rvFavorite;
    ...
    private void getData(View view) {
        database.quotesFavDAO().getAllQuotes().observe(requireActivity(), quotesFavs -> {
            adapter = new RecyclerViewFavoriteAdapter(quotesFavs, FavoriteFragment.this);
            favoriteRecyclerView.setAdapter(adapter);
        });
    }

    @Override
    public void showBottomDialog(View view, String quotes, String quotesAuthor) {
    ...
    @Override
    public void deleteClicked(QuotesFav deleteQuote) {
    ...
    private void deleteWarningPopup(QuotesFav deleteQuote) {
    ...
    private void deleteFavQuotes(QuotesFav deleteQuote) {
        Executors.newSingleThreadExecutor().execute(() -> database.quotesFavDAO().deleteQuotes(deleteQuote));
    }
}
